...
class SeattleEventScraper(LegistarAPIEventScraper, Scraper):
    BASE_URL = 'http://webapi.legistar.com/v1/seattle'
    WEB_URL = "https://seattle.legistar.com/"
    EVENTSPAGE = "https://seattle.legistar.com/Calendar.aspx"
